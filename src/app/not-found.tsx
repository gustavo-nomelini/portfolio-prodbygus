  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-[var(--background)] p-4">
      <div className="text-center max-w-md">
        <div className="flex justify-center mb-6">
          <div className="relative h-32 w-32 flex items-center justify-center">
            ...
            <FaExclamationTriangle
              className="h-16 w-16 text-[var(--color1)]"
              aria-hidden="true"
            />
          </div>
        </div>
        ...
        <h2 className="text-2xl font-semibold text-[var(--color1)] mb-6">
          Página não encontrada
        </h2>
        <p className="text-[var(--foreground-muted)] mb-8">
          Parece que você está procurando por uma página que não existe ou foi
          movida.
        </p>
        <Link
          href="/"
